...
const Samsung_galaxy = () => {

    const { newSamsungGalaxy } = useContext(Context);
                ...
                <div className="container">
                    ...
                    <div className="product__menu">
                        <div className="product__menu_top">
                            <h1>Смартфоны</h1>
                            <p><a href="/">Главная</a> / <a href="/telefon_gadjet_aksessuar/">Телефоны</a> / Samsung Galaxy</p>
                        </div>
