...
const Xiaomi_redmi = () => {
    const { newXiaomiRedmi } = useContext(Context)
                ...
                <div className="container">
                    ...
                    <div className="product__menu">
                        <div className="product__menu_top">
                            <h1>Смартфоны</h1>
                            <p><a href="/">Главная</a> / <a href="/telefon_gadjet_aksessuar/">Телефоны</a> / Xiaomi Redmi</p>
                        </div>
